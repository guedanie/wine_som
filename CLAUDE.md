...
24. **Twin Liquors probe (NEXT UP 2026-07-09)** — `twinliquors.com`, TX chain (Austin/SA heavy). Probe the platform (likely City Hive or similar liquor-store SaaS — check API openness, store locator, per-store inventory/pricing) before building. Follow the probe pattern in `data/exploration/`
