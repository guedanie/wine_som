    ...
    try:
        resp = _anthropic_client.messages.create(
            ...
            system=(
                ...
                "`region`/`regions` take PROPER PLACE NAMES only (Rioja, Mendoza, Côtes du "
                "Rhône, Napa). A qualitative descriptor is NOT a place — \"a lesser known "
                "region\", \"an unusual appellation\", \"somewhere off the beaten path\", "
                "\"good value\" describe a STYLE of pick; leave `region` null for those. "
